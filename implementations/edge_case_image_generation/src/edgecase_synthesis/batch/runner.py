...
from edgecase_synthesis.generate.annotation import AnnotationResult, OpenVocabAnnotator
...
def _annotate_item(
    ...
    *,
    ...
    from edgecase_synthesis.generate.annotation import target_label_names
...
def run_batch_synthesis(
    ...
    *,
    ...
    def synthesize_queue(items: list[PendingItem]) -> None:
        ...
        from edgecase_synthesis.batch.edit_mp import (
            EditJob,
