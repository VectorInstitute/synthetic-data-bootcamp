...
def project_root(start: Path | None = None) -> Path:
    """Return ``implementations/edge_case_image_generation`` (Hydra configs + data)."""
    ...
    raise FileNotFoundError(
        ...
        "(expected configs/config.yaml under implementations/edge_case_image_generation). "
...
def load_sample_images(
    ...
    *,
    ...
    if cfg is None and samples_dir is None:
        from aieng.syn_data.image.config import load_config  # noqa: PLC0415
