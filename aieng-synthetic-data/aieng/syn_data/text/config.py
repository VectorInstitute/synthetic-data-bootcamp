...
SYNTHETIC_IBT_RAW_PATH = DATA_DIR / "synthetic" / "synthetic_back_translation_raw.jsonl"
SYNTHETIC_IBT_PATH = DATA_DIR / "synthetic" / "synthetic_back_translation.jsonl"
...
DEFAULT_TEST_PARAS_PER_DOC = (
    10  # Number of test paragraphs to sample/generate per document
)
DEFAULT_SYNTHETIC_TARGET_SIZE = (
    100  # Target number of synthetic examples to generate for the dataset
)
